...
public class DaoController {
	...
	public String boardWrite(Board board) throws IllegalStateException, IOException {
	   ...
	   if(board.getBattach() != null && !board.getBattach().isEmpty()) {
		   ...
		   File file = new File("C:/Temp/upload/"+board.getBattachsname());
		   mf.transferTo(file);
	   }
	   boardService.writeBoard(board);
	...
	public void battachDownload(int bno, HttpServletResponse response) throws IOException {
		Board board = boardService.getBoard(bno);
        ...
        String battachspath = "C:/Temp/upload/" + battachsname;
